...
export const KNOWN_TOPIC_PHRASES = [
  ...
  "কপোতাক্ষ নদ", "জীবন-সঙ্গীত", "জুতা-আবিष्कार", "জুতা আবিষ্কার", "বঙ্গবাণী", "ঝিঙে ফুল", "প্রাণ", 
  "সেইদিন এই মাঠ", "পল্লীজননী", "রানার", "তোমাকে পাওয়ার জন্যে, হে স্বাধীনতা", "তোমাকে পাওয়ার জন্যে হে স্বাধীনতা", 
  "আমার পরিচয়", "স্বাধীনতা, এ শব্দটি কীভাবে আমাদের হলো", "কাকতাড়ুয়া", "বহিপীর",
  "সমাস", "সন্ধি", "ণ-ত্ব", "ষ-ত্ব", "ণ-ত্ব ও ষ-ত্ব", "ধ্বনি", "শব্দ", "বাক্য", "কারক", "প্রত্যয়", "উপসর্গ",
  // Physics
  "ভৌত রাশি ও পরিমাপ", "গতি", "বল", "কাজ, ক্ষমতা ও শক্তি", "কাজ ক্ষমতা ও শক্তি", "পদার্থের অবস্থা ও চাপ", 
  "বস্তুর উপর তাপের প্রভাব", "তরঙ্গ ও শব্দ", "আলোর প্রতিফলন", "আলোর প্রতিসরণ", "চোখের ক্রিয়া", "স্থির বিদ্যুৎ", 
  "চল বিদ্যুৎ", "বিদ্যুতের চৌম্বক ক্রিয়া", "আধুনিক পদার্থবিজ্ঞান ও ইলেকট্রনিক্স", "জীবন বাঁচাতে পদার্থবিজ্ঞান",
  // Chemistry
  "রসায়নের ধারণা", "পদার্থের অবস্থা", "পদার্থের গঠন", "পর্যায় সারণী", "পর্যায় সারণি", "রাসায়নিক বন্ধন", 
  ...
  "রেখা, কোণ ও ত্রিভুজ", "ব্যবহারিক জ্যামিতি", "বৃত্ত", "ত্রিকোণমিতিক অনুপাত", "দূরত্ব ও উচ্চতা", 
...
export function extractDirectTopicTokens(rawT, matchedChapterInfo) {
  ...
  const stopWords = new Set([
    ...
    'গল্প', 'উপন্যাস', 'নাটক', 'কবিতা', 'প্রবন্ধ', 'পদ্য', 'গদ্য', 'অংশ', 'নিয়ে', 'সম্পর্কে', 'বিষয়', 'বিষয়ক'
  ]);
