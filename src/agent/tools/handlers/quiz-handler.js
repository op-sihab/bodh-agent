...
export async function handleGetMcqQuiz(args) {
  ...
  return {
    ...
    instructions_for_mentor: isMockTest
      ? `অ্যাডাপ্টিভ কুইজ মোড: এটি ১০০% আসল ও প্রামাণিক বোর্ড পরীক্ষা/ক্যাডেট কলেজের প্রশ্ন [বোর্ড: ${formatTag(qTag)}]${boardWarning}। শিক্ষার্থীর সামনে কোনো কাল্পনিক ট্যাগ ছাড়া শুধু প্রশ্ন ও ৪টি অপশন (ক, খ, গ, ঘ) তুলে ধরো এবং শেষে [ans: ${normAns}] কোডটি দাও। ভুলেও সঠিক উত্তর ও ব্যাখ্যা লিখবে না! শিক্ষার্থী অপশন নির্বাচন করলে পরবর্তী টার্নে মূল্যায়ন করবে।`
      : `প্র্যাকটিস কুইজ মোড: এটি ১০০% প্রামাণিক প্রশ্ন [বোর্ড: ${formatTag(qTag)}]${boardWarning}। সুন্দরভাবে উপস্থাপন করে শেষে [ans: ${normAns}] কোডটি দাও।`
  };
}
